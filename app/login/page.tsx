        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Intelligent email organization powered by AI
            </p>
          </div>
          ...
          <div className="mb-8 space-y-3">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  AI sorts emails into custom categories
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Get concise AI-generated email summaries
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  AI-powered bulk unsubscribe from newsletters
                </p>
              </div>
            </div>
          ...
          <p className="mt-6 text-xs text-center text-gray-500 dark:text-gray-400">
            We only access your emails to organize them. Your data is encrypted
            and never shared.
          </p>
        </div>
      </div>
